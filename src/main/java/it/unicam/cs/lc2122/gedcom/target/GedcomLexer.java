...
public class GedcomLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"HEAD", "GEDC", "VERS", "CHAR", "TIME", "FILE", "LANG", "INDI", "NAME", 
			"GIVN", "SURN", "SEX", "BIRT", "DATE", "PLAC", "DEAT", "BURI", "FAMC", 
			"FAMS", "FAM", "HUSB", "WIFE", "CHIL", "MARR", "TRLR", "ANCE", "DESC", 
			"ZERO", "ONE", "TWO", "M", "F", "CODE", "TIMEFORMAT", "VERSION", "WS", 
			"NEWLINE", "STRING"
		};
	}
